...
import cat.itb.martigarcia7e4.dam2.m06.uf1.mapBot.model.*
import cat.itb.martigarcia7e4.dam2.m06.uf1.mapBot.model.Place.Companion.places
import cat.itb.martigarcia7e4.dam2.m06.uf1.mapBot.model.tmbRoute.Itineraries
...
class Logic {
    private val api = Api()
    val path = Path("src/main/kotlin/cat/itb/martigarcia7e4/dam2/m06/uf1/mapBot/resources/places.json")
